...
class RoleLLMConfig:
    ...
    Empty strings mean "use global default".
    Environment variables:
        NAL_{ROLE}_ENGINE: "claude-code" | "llm" | "fallback"
    ...
    def from_env(cls) -> EngineConfig:
        ...
        def _role_config(role: str) -> RoleLLMConfig:
            ...
            return RoleLLMConfig(
                engine=os.getenv(f"{prefix}_ENGINE", ""),
        ...
        return cls(
            ...
            coder=_role_config("coder"),
            reviewer=_role_config("reviewer"),
